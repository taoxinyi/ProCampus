"""
Django settings for ProCampus project.
...
WSGI_APPLICATION = 'ProCampus.wsgi.application'
# Channels
ASGI_APPLICATION = 'ProCampus.routing.application'
CHANNEL_LAYERS = {
    'default': {
